            ...
            <div class="rounded-t bg-white mb-0 px-6 py-6">
                <div class="text-center flex justify-between">
                    <h6 class="text-blueGray-700 text-xl font-bold">
                        Edit Category: {{ product_category.name }}
                    </h6>
                    <inertia-link
...
export default {
    ...
    setup(props) {
        const form = useForm({
            ...
            slug: props.product_category.slug,
            description: props.product_category.description,
            category_id: props.product_category.parent_category.id,
        });
    ...
    methods: {
        update() {
            this.form.put(route("categories.update", this.product_category.id));
        },
    },
};
</script>
